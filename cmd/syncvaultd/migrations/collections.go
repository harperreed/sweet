...
func init() {
	m.Register(func(app core.App) error {
		// sync_users collection (skip if exists)
		...
		// sync_changes collection (skip if exists)
		if _, err := app.FindCollectionByNameOrId("sync_changes"); err != nil {
		...
		// sync_snapshots collection (skip if exists)
		if _, err := app.FindCollectionByNameOrId("sync_snapshots"); err != nil {
